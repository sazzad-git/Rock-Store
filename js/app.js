...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <button onclick="detailsButton(${product.image}, ${product.category})" id="details-btn" class="btn btn-danger">Details</button></div>
      `;
...
function updateTotal() {
  ...
  let delivaryCharge = +document.getElementById("delivery-charge").innerText;
  let totalTex = +document.getElementById("total-tax").innerText;
  const grandTotal = price + delivaryCharge + totalTex;
